...
class Customer
{
     ...
     * @Assert\Length(min=3, minMessage="Le prénom doit faire entre 3 et 25 caractères", max=255, maxMessage="Le prénom doit faire entre 3 et 25 caractères")
     */
    private $firstName;
     ...
     * @Assert\Length(min=3, minMessage="Le nom de famille doit faire entre 3 et 25 caractères", max=255, maxMessage="Le nom de famille doit faire entre 3 et 25 caractères")
     */
    private $lastName;
